...
alpha = 8E1; %% INTERFACE SHOULD BE 10x delta_x
Kappa = 0.1%sqrt(E3/rho)/E3;
nu = 0.01;
M = 30;
c = sqrt(E3/rho);
...
for j = 2:nt
    ...
    for i = 1:nx
        stress(i) = stress_response100_1(Ux(i),Phi_old(i));
    end
    ...
    for i = 2:nx-1 % space    
        ...
        Phi_new(i) = Phi_old(i) + delta_t.*(abs(Phi_x(i)).*f_driving100_1(Ux(i),Phi_old(i),Phi_xx(i)).*Kappa ...
                                            + G_nucleation100_1(Ux(i),Phi_old(i)));
