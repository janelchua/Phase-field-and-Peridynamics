...
grid on
hold on
plot(M_a1,f_a1,'k-','linewidth',1) %Line at the boundary of the admissible region, negative M region. % s_dot [0,-c3]
plot(M_a2,f_a2,'k-','linewidth',1) %Line at the boundary of the admissible region, positive M region. % s_dot [0,c*]
